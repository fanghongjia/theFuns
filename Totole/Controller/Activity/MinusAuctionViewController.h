...
@interface MinusAuctionViewController : UIViewController
{
    ...
    __unsafe_unretained IBOutlet UILabel *label_33;
    __unsafe_unretained IBOutlet UILabel *label_41;
    __unsafe_unretained IBOutlet UILabel *label_42;
